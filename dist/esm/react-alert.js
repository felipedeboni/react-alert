...
var Provider = function Provider(_ref) {
  ...
  return React.createElement(Context$$1.Provider, {
    value: alertContext
  }, children, root.current && createPortal(React.createElement(React.Fragment, null, Object.keys(alertsByPosition).map(function (position) {
    return React.createElement(Wrapper, _extends({
      ...
      key: position
    }, props), React.createElement(TransitionGroup, null, alertsByPosition[position].map(function (alert) {
