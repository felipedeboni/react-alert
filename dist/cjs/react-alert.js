...
var Provider = function Provider(_ref) {
  ...
  return React__default.createElement(Context$$1.Provider, {
    value: alertContext
  }, children, root.current && reactDom.createPortal(React__default.createElement(React__default.Fragment, null, Object.keys(alertsByPosition).map(function (position) {
    return React__default.createElement(Wrapper, _extends({
      ...
      key: position
    }, props), React__default.createElement(reactTransitionGroup.TransitionGroup, null, alertsByPosition[position].map(function (alert) {
